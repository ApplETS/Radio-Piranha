 ...
 */
package ca.etsmtl.applets.visualizer.renderer;

import android.graphics.Canvas;
import android.graphics.Rect;

import ca.etsmtl.applets.visualizer.AudioData;
import ca.etsmtl.applets.visualizer.FFTData;
...
abstract public class Renderer {
     ...
     */
    protected abstract void onRender(Canvas canvas, AudioData data, Rect rect);
     ...
     * @param rect   - Rect to render into
     */
    protected abstract void onRender(Canvas canvas, FFTData data, Rect rect);
